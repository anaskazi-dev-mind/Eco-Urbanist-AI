...
import { Zap, Shield, Gauge, Code, ArrowRight, TrendingUp, Lock, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center text-white">
            <div className="transform hover:scale-125 transition-all duration-500 hover:rotate-3 cursor-pointer">
              <div className="flex items-center justify-center mb-2">
                ...
                <p className="text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white to-yellow-200">1000+</p>
              </div>
            ...
            <div className="transform hover:scale-125 transition-all duration-500 hover:rotate-3 cursor-pointer">
              <div className="flex items-center justify-center mb-2">
                ...
                <p className="text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white to-yellow-200">95%</p>
              </div>
              <p className="text-green-100 font-semibold">Avg. Green Coverage Boost</p>
            </div>
            <div className="transform hover:scale-125 transition-all duration-500 hover:rotate-3 cursor-pointer">
              <div className="flex items-center justify-center mb-2">
                <Lock className="w-8 h-8 mr-2 animate-bounce" />
                <p className="text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white to-yellow-200">100%</p>
              </div>
      ...
      <section className="py-24 bg-gradient-to-r from-green-500 via-emerald-500 to-green-600 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-300 rounded-full blur-3xl opacity-20 animate-pulse" style={{animationDelay: '1s'}}></div>
        ...
        <div className="container-custom text-center relative z-10">
          ...
          <p className="text-white mt-8 text-lg font-bold animate-bounce" style={{animationDelay: '0.5s'}}>
