...
const OnboardingTour = ({ run, onFinish }) => {
  ...
  useEffect(() => {
    if (run && location.pathname !== '/upload') {
      // Navigate to upload page when tour starts
      navigate('/upload');
    }
      ...
      content: (
        <div>
          ...
          <p className="text-gray-700 text-lg mb-4">
            Transform satellite images into green urban spaces using AI. Let's take a quick tour!
          </p>
      ...
      content: (
        <div>
          ...
          <p className="text-gray-700 mb-3">
            Drag & drop a satellite or aerial image here, or click to browse your files.
          </p>
          <div className="bg-blue-50 border-l-4 border-blue-500 p-3 rounded">
            <p className="text-sm text-blue-800">
              💡 <strong>Tip:</strong> Use Google Maps satellite view screenshots for best results!
            </p>
          </div>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-gray-700 mb-3">
            After uploading an image, you'll see a <strong className="text-green-600">"Generate Green Visualization"</strong> button.
          </p>
          ...
          <p className="text-sm text-gray-600">
            Click that button to let AI transform your image with trees and green spaces!
          </p>
        </div>
      ),
      placement: 'center',
        ...
        <div>
          ...
          <ul className="space-y-2 mb-4">
            <li className="flex items-start">
              ...
              <span className="text-gray-700">Before/After comparison slider</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-500 mr-2 text-xl">✓</span>
