      ...
      <div className="container-custom py-16 relative z-10">
        ...
        <div className="mb-16 bg-gradient-to-r from-red-500/10 via-orange-500/10 to-red-500/10 border-2 border-red-500/30 rounded-3xl p-8 backdrop-blur-sm">
          ...
          <p className="text-gray-300 text-lg mb-6 leading-relaxed">
            Green space planning in rapidly expanding modern cities is <span className="text-red-400 font-black">manual and time-consuming</span>. 
            Cities prioritize roads and buildings, adding greenery only as an <span className="text-red-400 font-black">afterthought</span>.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-gray-900/80 p-5 rounded-2xl border-2 border-red-500/30 hover:border-red-400 transition-all hover:scale-105 transform">
              ...
              <h4 className="font-black text-white mb-2 text-sm">Urban Heat Island</h4>
              <p className="text-xs text-gray-400">Concrete retains heat, raising local temperatures dramatically</p>
            </div>
            ...
            <div className="bg-gray-900/80 p-5 rounded-2xl border-2 border-orange-500/30 hover:border-orange-400 transition-all hover:scale-105 transform">
              ...
              <h4 className="font-black text-white mb-2 text-sm">Poor Air Quality</h4>
              <p className="text-xs text-gray-400">Lack of natural filtration and carbon absorption</p>
            </div>
            ...
            <div className="bg-gray-900/80 p-5 rounded-2xl border-2 border-blue-500/30 hover:border-blue-400 transition-all hover:scale-105 transform">
              ...
              <h4 className="font-black text-white mb-2 text-sm">Flooding Risks</h4>
              <p className="text-xs text-gray-400">Poor stormwater absorption due to lack of permeable surfaces</p>
            </div>
            ...
            <div className="bg-gray-900/80 p-5 rounded-2xl border-2 border-purple-500/30 hover:border-purple-400 transition-all hover:scale-105 transform">
              ...
              <h4 className="font-black text-white mb-2 text-sm">Climate Impact</h4>
              <p className="text-xs text-gray-400">Increased energy consumption and carbon footprint</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16 bg-gradient-to-r from-green-500/10 via-emerald-500/10 to-green-500/10 border-2 border-green-500/30 rounded-3xl p-8 backdrop-blur-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-3xl font-black text-white">Our AI-Powered Solution</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-900/80 p-6 rounded-2xl border-2 border-green-500/30 hover:border-green-400 transition-all hover:scale-105 transform hover:shadow-2xl hover:shadow-green-500/20">
              ...
              <h4 className="font-black text-white mb-3 text-lg">🏗️ Infrastructure-Aware</h4>
              <p className="text-sm text-gray-400 leading-relaxed">
                Automatically detects and <span className="text-green-400 font-bold">preserves existing buildings, roads, and water bodies</span>. 
            ...
            <div className="bg-gray-900/80 p-6 rounded-2xl border-2 border-blue-500/30 hover:border-blue-400 transition-all hover:scale-105 transform hover:shadow-2xl hover:shadow-blue-500/20">
              ...
              <h4 className="font-black text-white mb-3 text-lg">📊 Measurable Impact</h4>
              <p className="text-sm text-gray-400 leading-relaxed">
                Provides <span className="text-blue-400 font-bold">quantifiable metrics</span> with before/after green coverage percentages. 
                Not just visuals—real data!
              </p>
            </div>
            ...
            <div className="bg-gray-900/80 p-6 rounded-2xl border-2 border-purple-500/30 hover:border-purple-400 transition-all hover:scale-105 transform hover:shadow-2xl hover:shadow-purple-500/20">
              ...
              <h4 className="font-black text-white mb-3 text-lg">⚡ Instant Results</h4>
              <p className="text-sm text-gray-400 leading-relaxed">
                Transforms <span className="text-purple-400 font-bold">days/weeks of manual planning into seconds</span>. 
        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md leading-relaxed text-base">
              🌍 <span className="font-bold text-green-400">AI-powered urban planning</span> combining computer vision and generative AI to automatically produce 
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-2.5 flex-wrap">
              ...
              <span className="bg-gradient-to-r from-gray-800 to-gray-900 px-4 py-2 rounded-full text-xs font-black text-gray-300 border-2 border-gray-700 hover:border-green-500 transition-all shadow-lg">🎨 GAN Model</span>
